...
please mark these with the following statuses. if not flagged, presume an open ended idea
...
- done - interacting with a certain appliances/entities should spawn a secondary selection system. for example Draft will open a submenu with arrow key and number selection letting you pick option 1,2,3,4 perhaps pilsner, lager, ale, ipa. same for wine, merlot, chard, etc. This will be needed for making more complicated drinks in the future.
- done - customer chairs should be marked by small rounded rectangles about the size of a customer.
- done - glasses customers are drinking should be visible on the bar, with visible depletion.
