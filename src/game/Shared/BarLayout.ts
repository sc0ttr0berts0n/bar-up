...
function buildDefaultLayout(): IBarLayout {
  ...
  const appliances: IAppliancePlacement[] = [
    ...
    { type: EApplianceType.COUNTER, gridX: 8, gridY: 3 },
    { type: EApplianceType.COUNTER, gridX: 9, gridY: 3 },
    { type: EApplianceType.COUNTER, gridX: 10, gridY: 3 },
    ...
    { type: EApplianceType.COUNTER, gridX: 16, gridY: 3 },
    { type: EApplianceType.COUNTER, gridX: 17, gridY: 3 },

    // Behind bar appliances (row 1-2)
    { type: EApplianceType.GLASS_SHELF, gridX: 2, gridY: 1 },
